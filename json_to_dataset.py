...
if __name__ == '__main__':
    ...
    classes    = ["_background_","Tomato_Late_blight","Tomato_Early_blight","Tomato_Leaf_Mold","Tomato_Septoria_leaf_spot","Tomato_Spider_mites_Two_spotted_spider_mite","Tomato_Target_Spot","Tomato_YellowLeaf_Curl_Virus","Tomato_Mosaic_virus","Tomato_Healthy","Tomato_Bacterial_spot"]
